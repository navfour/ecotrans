...
from src.models.model import Informer, InformerStack

import torch
# from ecoforest.src.nbeats.transformer2 import test_data
from src.transformer2 import Exp_Informer


# from torch import nn
# from ecoforest.src.nbeats.data.data_loader import Dataset_ETT_hour, Dataset_ETT_minute, Dataset_Custom, Dataset_Pred
...
def getx_t(data_df, seq_len, dim):
    ...
    data_parser = {
        ...
        'WTH': {'data': 'WTH.csv', 'T': 'red', 'M': [dim, dim, dim], 'S': [1, 1, 1], 'MS': [dim, dim, 1]},
    ...
    setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_mx{}_{}_{}'.format(args.model,
                                                                                                         ...
                                                                                                         ii)
    exp = Exp(args)
    train_data, train_loader = exp.test_data(setting, data_df)

    for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
        pred, true = exp._process_one_batch(train_data, batch_x, batch_y, batch_x_mark, batch_y_mark)
    return pred, true
